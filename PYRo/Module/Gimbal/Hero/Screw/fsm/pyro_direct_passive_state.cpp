...
void screw_gimbal_t::state_passive_t::enter(owner *owner)
{
...
void screw_gimbal_t::state_passive_t::execute(owner *owner)
{
...
void screw_gimbal_t::state_passive_t::exit(owner *owner)
{
}
} // namespace pyro